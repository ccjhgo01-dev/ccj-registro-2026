  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="space-y-8">
      ...
      <fieldset className="bg-beige rounded-2xl p-6 border border-dorado/20 space-y-5">
        ...
        {/* Nombre */}
        <div>
          <label className="block text-tierra-oscuro font-semibold text-sm mb-1.5" htmlFor="nombre_completo">
          ...
          <input
            ...
            className="w-full bg-crema border border-dorado/30 rounded-xl px-4 py-3 text-tierra-oscuro placeholder-tierra/40 focus:border-verde-olivo focus:bg-white transition-colors outline-none"
          />
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          {/* Correo */}
          <div>
            <label className="block text-tierra-oscuro font-semibold text-sm mb-1.5" htmlFor="correo">
          ...
          {/* Teléfono */}
          <div>
            <label className="block text-tierra-oscuro font-semibold text-sm mb-1.5" htmlFor="telefono">
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          {/* Edad */}
          <div>
            <label className="block text-tierra-oscuro font-semibold text-sm mb-1.5" htmlFor="edad">
          ...
          {/* Municipio */}
          <div>
            <label className="block text-tierra-oscuro font-semibold text-sm mb-1.5" htmlFor="municipio">
            ...
            <select
              ...
              onChange={handleChange}
              className="w-full bg-crema border border-dorado/30 rounded-xl px-4 py-3 text-tierra-oscuro focus:border-verde-olivo focus:bg-white transition-colors outline-none"
            >
        ...
        {/* Institución */}
        <div>
          <label className="block text-tierra-oscuro font-semibold text-sm mb-1.5" htmlFor="institucion">
      ...
      <fieldset className="bg-beige rounded-2xl p-6 border border-dorado/20">
        ...
        <div className="space-y-3">
          {ACTIVIDADES.map((act) => (
            <label
              key={act.id}
              className="flex gap-3 items-start p-4 rounded-xl bg-crema border border-dorado/20 cursor-pointer hover:border-verde-olivo transition-colors group"
            >
              <input
                type="checkbox"
                name="actividades"
              ...
              <div>
                ...
                <p className="text-tierra-oscuro font-semibold text-sm group-hover:text-verde-oscuro transition-colors">
                  {act.titulo}
                </p>
          ...
          {/* Opción cumbre */}
          <label className="flex gap-3 items-start p-4 rounded-xl bg-verde-oscuro/10 border-2 border-verde-olivo cursor-pointer hover:bg-verde-oscuro/15 transition-colors group">
            <input
              type="checkbox"
              name="asiste_cumbre"
      ...
      <fieldset className="bg-beige rounded-2xl p-6 border border-dorado/20 space-y-5">
        ...
        {/* ¿Cómo te enteraste? */}
        <div>
          <label className="block text-tierra-oscuro font-semibold text-sm mb-1.5" htmlFor="como_te_enteraste">
        ...
        {/* Mensaje opcional */}
        <div>
          <label className="block text-tierra-oscuro font-semibold text-sm mb-1.5" htmlFor="mensaje">
            ¿Algo que quieras compartir al equipo? <span className="text-tierra/50">(opcional)</span>
          </label>
          <textarea
            id="mensaje"
            name="mensaje"
            ...
            className="w-full bg-crema border border-dorado/30 rounded-xl px-4 py-3 text-tierra-oscuro placeholder-tierra/40 focus:border-verde-olivo focus:bg-white transition-colors outline-none resize-none"
          />
        </div>
      </fieldset>
      ...
      <button
        type="submit"
        disabled={isPending}
        className="w-full bg-verde-olivo hover:bg-verde-oscuro disabled:opacity-60 disabled:cursor-not-allowed text-crema font-display font-semibold text-xl py-4 rounded-2xl transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5 flex items-center justify-center gap-3"
      >
        {isPending ? (
          <>
